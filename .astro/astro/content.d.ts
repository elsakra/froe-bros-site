...
"locations": {
"froe-bros-drilling.md": {
	id: "froe-bros-drilling.md";
  slug: "froe-bros-drilling";
  body: string;
...
"services": {
"complete-water-systems.md": {
	id: "complete-water-systems.md";
  slug: "complete-water-systems";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"geothermal-wells.md": {
	id: "geothermal-wells.md";
  slug: "geothermal-wells";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"hydro-fracking.md": {
	id: "hydro-fracking.md";
  slug: "hydro-fracking";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"pump-sales-and-service.md": {
	id: "pump-sales-and-service.md";
  slug: "pump-sales-and-service";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"solar-power-wells.md": {
	id: "solar-power-wells.md";
  slug: "solar-power-wells";
  body: string;
  collection: "services";
  data: InferEntrySchema<"services">
} & { render(): Render[".md"] };
"water-well-drilling.md": {
	id: "water-well-drilling.md";
...
"team": {
"joe-froehlingsdorf.md": {
	id: "joe-froehlingsdorf.md";
  slug: "joe-froehlingsdorf";
  body: string;
  collection: "team";
  data: InferEntrySchema<"team">
} & { render(): Render[".md"] };
"tom-froehlingsdorf.md": {
	id: "tom-froehlingsdorf.md";
  slug: "tom-froehlingsdorf";
  body: string;
  collection: "team";
  data: InferEntrySchema<"team">
} & { render(): Render[".md"] };
